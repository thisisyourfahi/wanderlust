            ...
            <div className="p-10 text-center flex justify-center flex-col items-center gap-3.5 flex-1">
                ...
                <div className="flex gap-5">
                    <Link href={'/destinations'}>
                        <Button className="uppercase rounded-none px-5 py-3 bg-white/50 cursor-pointer">
                            View Destination
                        </Button>
                    </Link>

                    <Button className="uppercase rounded-none bg-cyan-500 px-5 py-3 cursor-pointer">
                        Explore Now
                    </Button>
                </div>
            </div>
